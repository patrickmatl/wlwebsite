...
export const PRICING: PriceCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        // Was null/"quoted on request" while the page sold three concrete
        // packages. A client reading R19,780 and being told their enquiry needs
        // a scoping call reads as the studio not knowing its own prices, so the
        // three published tiers are carried here verbatim.
        notes: 'Matches the Basic package published on the e-commerce page',
      },
      {
        id: 'ecommerce-advanced',
        name: 'E-commerce website — Advanced',
        amount: 23690,
        unit: 'fixed',
        includes: [
      ...
      },
      {
        ...
        name: 'E-commerce website — Premium',
        amount: 27980,
        unit: 'fixed',
        includes: [
          'Everything in the Advanced package',
          'Custom features built to the brief',
      ...
      },
      {
        ...
        amount: 2580,
        unit: 'fixed',
        includes: ['Payment provider connected, tested and live'],
        url: '/pricing/ecommerce-pretoria',
      },
      {
        ...
        amount: 4890,
        unit: 'fixed',
        includes: ['Stock levels tracked against orders', 'Low-stock alerts'],
        url: '/pricing/ecommerce-pretoria',
      },
      {
        id: 'custom-api-integration',
        name: 'API and integration work',
        amount: 18780,
        unit: 'from',
        includes: [
          'Two systems connected and kept in sync',
          'Authentication and error handling',
          'Documentation of the integration',
        ],
        url: '/pricing/custom-development-pretoria',
      },
      {
        id: 'custom-web-app',
        ...
        unit: 'from',
        includes: [
          'Built around your workflow rather than a template',
          'Admin area for your team',
      ...
      },
      {
        ...
        unit: 'from',
        includes: [
          'Multi-role system scoped to your operation',
          'Integration with software you already run',
          'Reporting and audit trail',
          'Handover with documentation',
        ],
        url: '/pricing/custom-development-pretoria',
        notes: 'From price only - always scope properly before committing to a number',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        name: 'Google Ads management - Starter',
        amount: 4850,
        unit: 'per-month',
        includes: [
          'Campaign built and launched',
          'Keyword and negative-keyword management',
          'Monthly performance report',
        ],
        url: '/pricing/google-ads-pretoria',
        notes: 'Management fee only - the advertising spend is paid by the client directly to Google',
      },
      {
        id: 'google-ads-growth',
        name: 'Google Ads management - Growth',
        amount: 8850,
        unit: 'per-month',
        includes: [
        ...
        url: '/pricing/google-ads-pretoria',
        notes: 'Management fee only - advertising spend is separate and paid to Google by the client',
      },
      {
        id: 'google-ads-enterprise',
        name: 'Google Ads management - Enterprise',
        amount: 15850,
        unit: 'per-month',
        includes: [
          'Full account structure across search, display and shopping',
      ...
      {
        id: 'ads-landing-page',
        name: 'Campaign landing page design',
        amount: 4850,
        unit: 'from',
        includes: [
          'Single page built to convert one campaign',
          'Copy laid out with a clear call to action',
          'Mobile-first build',
      ...
      {
        id: 'email-campaign-once',
        name: 'One-time email campaign',
        amount: 950,
        unit: 'from',
        includes: [
          'One campaign designed and built',
          'List uploaded and segmented',
          'Sent and the results reported',
        ],
        url: '/pricing/email-marketing-pretoria',
      },
      {
        id: 'email-essential',
        name: 'Email marketing - Essential',
        amount: 2850,
        unit: 'per-month',
        includes: [
          'One campaign a month, designed and sent',
          'List management',
      ...
      },
      {
        ...
        unit: 'per-month',
        includes: [
          'Full campaign calendar managed',
          'Automated journeys and triggered sends',
          'Advanced segmentation',
          'Detailed reporting and review call',
        ],
        url: '/pricing/email-marketing-pretoria',
      },
    ],
  },
  {
    ...
    items: [
      ...
      {
        id: 'drone-starter',
        name: 'Drone video - Starter',
        amount: 4500,
        unit: 'fixed',
        includes: [
          'Licensed drone operator on site',
          'Up to 1 hour of aerial filming',
          'Edited highlight clip',
          'Full HD delivery',
        ],
        url: '/pricing/drone-video-pretoria',
      },
      {
        id: 'drone-business',
        name: 'Drone video - Business',
        amount: 7900,
        unit: 'fixed',
        includes: [
          'Half-day aerial shoot',
          'Edited video with music and colour grading',
          '4K delivery',
          'Selection of stills',
        ],
        url: '/pricing/drone-video-pretoria',
      ...
      {
        id: 'drone-premium',
        name: 'Drone video - Premium',
        amount: 13500,
        unit: 'fixed',
        includes: [
          'Full-day aerial shoot',
          'Ground and aerial footage combined',
          'Full edit with motion graphics',
          '4K delivery plus social cutdowns',
        ],
        url: '/pricing/drone-video-pretoria',
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        id: 'photo-product-premium',
        name: 'Product photography - Premium',
        amount: 5900,
        unit: 'fixed',
        includes: [
          'Larger product set shot and retouched',
          'Styled and lifestyle set-ups',
          'High-resolution and web-sized files',
        ],
        url: '/pricing/product-photography-pretoria',
      },
      {
        id: 'photo-event',
