  ...
  const navItems = [
    ...
    { label: 'About', href: '/about-graphic-design-company-pretoria' },
    {
      ...
      subItems: [
        ...
        { label: 'SEO Services', href: '/pricing/seo-pretoria' },
        { label: 'Content Marketing', href: '/pricing/content-marketing-pretoria' },
        { label: 'Email Marketing', href: '/pricing/email-marketing-pretoria' },
