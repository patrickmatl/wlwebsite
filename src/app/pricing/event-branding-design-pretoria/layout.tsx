...
export const metadata: Metadata = {
  ...
  description: 'Event branding design in Pretoria from R5,850: event logos, signage, lanyards, digital banners and print-ready collateral for conferences and launches.',
