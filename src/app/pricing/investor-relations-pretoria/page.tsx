...
/**
 * This URL was a thin near-duplicate of /pricing/investor-relations-material-design-services-pretoria
...
export default function Page() {
  redirect('/pricing/investor-relations-material-design-services-pretoria');
}