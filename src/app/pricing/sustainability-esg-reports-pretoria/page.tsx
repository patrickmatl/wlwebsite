...
/**
 * This URL was a thin near-duplicate of /pricing/sustainability-esg-report-design-services-pretoria
...
export default function Page() {
  redirect('/pricing/sustainability-esg-report-design-services-pretoria');
}