...
/**
 * This URL was a thin near-duplicate of /pricing/infographic-data-visualization-design-pretoria
...
export default function Page() {
  redirect('/pricing/infographic-data-visualization-design-pretoria');
}