...
/**
 * A quote, openable by anyone holding the link.
 *
 * The point is that a client can forward it to whoever signs off the spend
 * without that person needing an account. The token is 24 random bytes and
 * grants read-only access to exactly one document; drafts are never reachable,
 * and revoking is a matter of nulling one column.
 */
